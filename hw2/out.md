...
|   Parameter   |   First Guess   | Estimated Value | Standard Error |
| :-----------: | :-------------: | :------------: | :------------: |
| $\beta_0$ | 7.81921751 |      7.81921708 |     0.04870465 |
|    $\beta_0$    |  0.30213254 |      0.30213284 |     0.04328226 |
| $\beta_0$ | 0.47635255 |      0.47635371 |     0.10201014 |
| $\beta_0$ | 0.27349885 |       0.2734988 |     0.05056296 |
| $\beta_1$ | 7.81921751 |       7.8192177 |     0.04870461 |
| $\beta_1$ | 0.30213254 |      0.30213257 |     0.04328222 |
| $\beta_1$ | 0.47635255 |      0.47635472 |     0.10201044 |
| $\beta_1$ | 0.27349885 |      0.27349878 |     0.05056286 |
| $\gamma$ | 0.33742315 |      -0.4353483 |     0.08313967 |
| $\gamma$ | 0.0501172 |       0.1362415 |     0.04872624 |
| $\gamma$ | -0.0485959 |      -0.1255597 |     0.11287811 |
| $\gamma$ | 0.10296371 |      0.27133711 |     0.06139946 |
| $\gamma$ | 0.31949973 |      0.84976264 |     0.12406831 |
| $\gamma$ | -0.0491629 |      -0.1442248 |     0.27753458 |
| $\omega_1$ | -0.1503975 |      -0.1439185 |     0.05197017 |
| $\omega_1$ | -0.2292919 |      -0.2302358 |       0.033553 |
| $\omega_1$ | 0.23938166 |      0.23011268 |     0.04289702 |
| $\omega_1$ | 0.29291972 |      0.28724934 |     0.06432697 |
| $\omega_1$ | -0.1786147 |      -0.1596855 |     0.09643413 |
| $\omega_1$ | 0.17397637 |       0.1715684 |     0.04324387 |
| $\omega_1$ | 0.29540971 |      0.31945617 |     0.06239367 |
| $\omega_1$ | -0.0763001 |      -0.0757068 |     0.08807978 |
| $\omega_1$ | -0.0054305 |      0.00521931 |     0.04304264 |
| $\omega_1$ | 0.28356929 |      0.28378209 |     0.11002384 |
| $\omega_1$ | 0.14870944 |      0.12959975 |     0.04906602 |
| $\omega_1$ | 0.22041453 |      0.20919163 |     0.05453735 |
| $\omega_1$ | 0.00582187 |      -0.0065869 |     0.10816752 |
| $\omega_1$ | 0.0253811 |      0.02681309 |     0.07944891 |
| $\omega_1$ | 0.04098989 |      0.04333963 |     0.03976408 |
| $\omega_2$ | -0.2713906 |       -0.265488 |     0.05135096 |
| $\omega_2$ | 0.08360803 |      0.08274793 |     0.03314235 |
| $\omega_2$ | 0.19105642 |      0.18261303 |     0.04240422 |
| $\omega_2$ | 0.30830376 |      0.30313879 |     0.06358904 |
| $\omega_2$ | -0.2331679 |      -0.2159232 |     0.09532613 |
| $\omega_2$ | 0.15780901 |      0.15561507 |     0.04275075 |
| $\omega_2$ | 0.21425512 |      0.23616125 |     0.06166408 |
| $\omega_2$ | -0.034465 |      -0.0339236 |     0.08707646 |
| $\omega_2$ | 0.05519643 |      0.06489823 |     0.04254685 |
| $\omega_2$ | 0.31781979 |      0.31801493 |     0.10876592 |
| $\omega_2$ | 0.11564513 |      0.09823527 |     0.04849112 |
| $\omega_2$ | 0.21865492 |       0.2084306 |      0.0539072 |
| $\omega_2$ | 0.00325869 |      -0.0080477 |     0.10693163 |
| $\omega_2$ | 0.08401 |      0.08531422 |     0.07847687 |
| $\omega_2$ | 0.00297771 |      0.00511872 |     0.03927803 |
| $\omega_3$ | -0.34945 |      -0.3435333 |     0.05253868 |
| $\omega_3$ | 0.15707814 |      0.15621576 |      0.0339065 |
| $\omega_3$ | 0.23003966 |      0.22157547 |     0.04338929 |
| $\omega_3$ | 0.39078392 |      0.38560581 |     0.06506685 |
| $\omega_3$ | -0.0941769 |      -0.0768919 |     0.09754074 |
| $\omega_3$ | 0.14080378 |      0.13860485 |     0.04374495 |
| $\omega_3$ | 0.23393783 |       0.2558973 |      0.0630931 |
| $\omega_3$ | -0.1239506 |       -0.123407 |     0.08910147 |
| $\omega_3$ | 0.01120986 |      0.02093546 |     0.04353481 |
| $\omega_3$ | 0.28431811 |      0.28451287 |      0.1112932 |
| $\omega_3$ | 0.1999961 |      0.18254442 |     0.04961437 |
| $\omega_3$ | 0.25662168 |      0.24637216 |     0.05515842 |
| $\omega_3$ | -0.0108028 |      -0.0221353 |     0.10941769 |
| $\omega_3$ | 0.00273118 |       0.0040397 |     0.08028637 |
| $\omega_3$ | 0.01768387 |      0.01983037 |     0.04018385 |
| $\omega_4$ | -0.2372087 |       -0.230814 |     0.05358091 |
| $\omega_4$ | 0.01349295 |      0.01256138 |     0.03458659 |
| $\omega_4$ | 0.19202861 |      0.18288027 |     0.04423705 |
| $\omega_4$ | 0.37005435 |      0.36445828 |     0.06633709 |
| $\omega_4$ | -0.1883642 |        -0.16968 |      0.0994465 |
| $\omega_4$ | 0.15169444 |      0.14931767 |     0.04459695 |
| $\omega_4$ | 0.27287459 |       0.2966095 |     0.06433515 |
| $\omega_4$ | -0.0452241 |      -0.0446379 |     0.09083632 |
| $\omega_4$ | -0.0288337 |      -0.0183219 |     0.04438648 |
| $\omega_4$ | 0.25503971 |       0.2552503 |      0.1134633 |
| $\omega_4$ | 0.12782786 |      0.10896538 |       0.050592 |
| $\omega_4$ | 0.17542776 |      0.16435029 |     0.05623886 |
| $\omega_4$ | 0.02031771 |       0.0080692 |     0.11155019 |
| $\omega_4$ | -0.0003915 |      0.00102197 |     0.08189654 |
| $\omega_4$ | -0.013706 |      -0.0113865 |     0.04098944 |
| $\sigma_0$ | 1.1519522 |      0.13653706 |     0.01329632 |
| $\sigma_1$ | 1.1519522 |      0.13653707 |     0.01329631 |
| $\sigma_{T_1}$ | 0.89237697 |      -0.6704545 |     0.02038455 |
| $\sigma_{T_2}$ | 0.88146705 |      -0.5504599 |     0.01710144 |
| $\sigma_{T_3}$ | 0.90179417 |       -0.501899 |     0.01669583 |
| $\sigma_{T_4}$ | 0.91987314 |      -0.5622838 |     0.01834335 |
| $\alpha_0$ | 1 |      0.14479556 |     0.03259601 |
| $\alpha_1$ | 1 |      0.14479572 |     0.03259603 |
| $\alpha_I$ | 1 |      0.03696093 |     0.03619097 |
| $\alpha_{T_2}$ | 1 |      0.91102389 |     0.02197503 |
| $\alpha_{T_3}$ | 1 |      0.91323262 |      0.0228353 |
| $\alpha_{T_4}$ | 1 |      0.98708182 |      0.0233811 |
| $\sigma_\theta$ | 1 |      -0.3167767 |     0.02020435 |
